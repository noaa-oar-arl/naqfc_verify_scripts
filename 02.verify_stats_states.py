...
if __name__ == '__main__':
    ...
    parser.add_argument('-b',   '--subset_epa',  help='boolean set to True for subsetting by U.S. State', type=bool, required=False, default=False)
    parser.add_argument('-e',   '--epa_regions', help='string/list input for set U.S. state regions',type=str,nargs='+', required=False, default=['CA'])
